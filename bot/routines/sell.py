...
SLEEP_AFTER_RIGHT_CLICK = schedule.SELL_AFTER_RIGHT_CLICK
SLEEP_AFTER_DISMISS = schedule.SELL_AFTER_DISMISS
...
def sell_item(name: str, threshold: float = ITEM_THRESHOLD,
              color: bool = False, undercut: bool = False,
              pre_delay: float = 0.0) -> bool:
    ...
    pre_delay: espera antes del right-click (ej. lucent motes: el salvage sigue
               soltando y la ventana del TP no abre si clickeamos enseguida).
    """
